...
export const URL_CONFIGURABLE_PROVIDERS = ['Ollama', 'LMStudio', 'geminiLike'];
export const LOCAL_PROVIDERS = ['geminiLike', 'LMStudio', 'Ollama'];
...
const getInitialTabConfiguration = (): TabWindowConfig => {
  ...
  try {
    const saved = localStorage.getItem('smack_tab_configuration');
...
export const resetTabConfiguration = () => {
  ...
  localStorage.setItem('smack_tab_configuration', JSON.stringify(defaultConfig));
};
