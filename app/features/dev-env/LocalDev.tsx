  ...
  const environments = [
    {
      ...
      volumes: [
        { host: '/Users/john/projects/my-app', container: '/app' },
      ],
    ...
    },
    {
      ...
      ports: [
        { internal: 8000, external: 8001, protocol: 'http' }
      ],
      volumes: [
        { host: '/Users/john/projects/api-server', container: '/app' },
      ],
    ...
    },
    {
      ...
      ports: [
        { internal: 5432, external: 5433, protocol: 'tcp' }
      ],
      volumes: [
        { host: '/Users/john/data/postgres', container: '/var/lib/postgresql/data' },
      ],
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="min-h-[600px]">
        ...
        {activeTab === 'create' && (
          <CreateEnvironmentTab availableImages={availableImages} />
        )}
        {activeTab === 'images' && (
          <ImagesTab availableImages={availableImages} />
        )}
      </div>
...
function EnvironmentsTab({ environments, onSelectEnvironment }: {
  environments: any[],
        ...
        <div key={category}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {availableImages
              ...
              .map((image) => (
                <div key={image.name} className="p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
