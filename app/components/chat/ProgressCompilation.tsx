      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-smack-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-smack-elements-item-backgroundAccent hover:bg-smack-elements-artifacts-backgroundHover"
