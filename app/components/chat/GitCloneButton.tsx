...
import { detectProjectCommands, createCommandsMessage, escapesmackTags } from '~/utils/projectCommands';
    ...
    <>
      ...
      {isDialogOpen && !selectedProvider && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-smack-elements-borderColor dark:border-smack-elements-borderColor max-w-md w-full">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-smack-elements-textPrimary dark:text-smack-elements-textPrimary">
                  Choose Repository Provider
                </h3>
                <button
                  onClick={() => setIsDialogOpen(false)}
                  className="p-2 rounded-lg bg-transparent hover:bg-smack-elements-background-depth-1 dark:hover:bg-smack-elements-background-depth-1 text-smack-elements-textSecondary dark:text-smack-elements-textSecondary hover:text-smack-elements-textPrimary dark:hover:text-smack-elements-textPrimary transition-all duration-200 hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary">
                        GitHub
                      </div>
                      <div className="text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary">
      ...
      {isDialogOpen && selectedProvider === 'github' && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-smack-elements-borderColor dark:border-smack-elements-borderColor w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b border-smack-elements-borderColor dark:border-smack-elements-borderColor flex items-center justify-between">
              <div className="flex items-center gap-3">
