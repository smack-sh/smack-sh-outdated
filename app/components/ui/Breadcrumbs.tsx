      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark'
              : 'text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark hover:text-smack-elements-textPrimary dark:hover:text-smack-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-smack-elements-textTertiary dark:text-smack-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
