  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-smack-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-smack-elements-background-depth-2 border-y border-smack-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-smack-elements-terminals-buttonBackground text-smack-elements-textSecondary hover:text-smack-elements-textPrimary':
                            isActive,
                          'bg-smack-elements-background-depth-2 text-smack-elements-textSecondary hover:bg-smack-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-smack-elements-terminals-buttonBackground text-smack-elements-textPrimary': isActive,
                            'bg-smack-elements-background-depth-2 text-smack-elements-textSecondary hover:bg-smack-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-smack-elements-textTertiary hover:text-smack-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachsmackTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting smack terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachsmackTerminal(terminal)}
