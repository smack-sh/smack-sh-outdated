    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from smack.sh' : 'Update from smack.sh',
          tree: treeData.sha,
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-smack-elements-background-depth-1 rounded-lg border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-smack-elements-textTertiary hover:text-smack-elements-textPrimary dark:text-smack-elements-textTertiary-dark dark:hover:text-smack-elements-textPrimary-dark hover:bg-smack-elements-background-depth-2 dark:hover:bg-smack-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-smack-elements-borderColor dark:focus:ring-smack-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 rounded-lg p-4 text-left border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark">
                    <p className="text-sm font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-red-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-smack-elements-background-depth-1 dark:bg-smack-elements-background-depth-4 px-3 py-2 rounded border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-smack-elements-textSecondary hover:text-smack-elements-textPrimary dark:text-smack-elements-textSecondary-dark dark:hover:text-smack-elements-textPrimary-dark bg-smack-elements-background-depth-1 dark:bg-smack-elements-background-depth-4 rounded-lg border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark"
                  ...
                  <div className="bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 rounded-lg p-4 border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark">
                    <p className="text-sm font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark mb-2 flex items-center gap-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark border-b border-smack-elements-borderColor/30 dark:border-smack-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-smack-elements-background-depth-3 dark:bg-smack-elements-background-depth-4 text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark ml-2">
                            {(file.size / 1024).toFixed(1)} KB
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark">
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-smack-elements-background-depth-1 rounded-lg p-6 border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark shadow-xl"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-smack-elements-background-depth-3 flex items-center justify-center text-red-500"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitHub, you need to connect your GitHub account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark text-sm hover:bg-smack-elements-background-depth-3 dark:hover:bg-smack-elements-background-depth-4 border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-smack-elements-background-depth-3 flex items-center justify-center text-red-500"
                  >
                    <div className="i-ph:github-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark">
                      Deploy to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 rounded-lg border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark">
                  ...
                  <div>
                    <p className="text-sm font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark">
                      {user.name || user.login}
                    </p>
                    <p className="text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark">
                      @{user.login}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-smack-elements-textTertiary dark:text-smack-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark placeholder-smack-elements-textTertiary dark:placeholder-smack-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-red-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                        <span className="font-mono text-red-600 dark:text-red-400">{sanitizeRepoName(repoName)}</span>
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-smack-elements-textTertiary dark:text-smack-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 hover:bg-smack-elements-background-depth-3 dark:hover:bg-smack-elements-background-depth-4 transition-colors group border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark hover:border-red-500/30"
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark group-hover:text-red-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3 rounded-lg border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark text-red-500 focus:ring-red-500 dark:bg-smack-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-smack-elements-textTertiary dark:text-smack-elements-textTertiary-dark mt-2 ml-6">
