      ...
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[10000]">
          ...
          >
            ...
            >
              <Dialog.Title className="text-lg font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark mb-4">
                Connect to GitLab
              </Dialog.Title>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-base font-medium text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark">
                    GitLab Connection
                  </h3>
                  <p
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark mb-2">
                    GitLab URL
                  </label>
                  <input
                    type="url"
                    ...
                    className={classNames(
                      ...
                      'bg-smack-elements-background-depth-2 dark:bg-smack-elements-background-depth-3',
                      'border border-smack-elements-borderColor dark:border-smack-elements-borderColor-dark',
                      'text-smack-elements-textPrimary dark:text-smack-elements-textPrimary-dark',
                      'placeholder-smack-elements-textTertiary dark:placeholder-smack-elements-textTertiary-dark',
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <div className="mt-2 text-xs text-smack-elements-textSecondary dark:text-smack-elements-textSecondary-dark">
                    <a
