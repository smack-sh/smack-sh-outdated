    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-smack-elements-textPrimary">GitHub Integration</h2>
        </div>
    ...
    <GitHubErrorBoundary>
      <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-smack-elements-background dark:bg-smack-elements-background-depth-2 border border-smack-elements-borderColor dark:border-smack-elements-borderColor hover:border-smack-elements-borderColorActive/70 dark:hover:border-smack-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-smack-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-smack-elements-textSecondary hover:text-smack-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-smack-elements-borderColor">
