    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:bug w-4 h-4 text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors" />
            Report Bug
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:download w-4 h-4 text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors" />
            Download Debug Log
          </DropdownMenu.Item>
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://stackblitz-labs.github.io/smack.sh/', '_blank')}
          >
            <div className="i-ph:question w-4 h-4 text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors" />
            Help & Documentation
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
